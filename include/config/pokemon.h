...
#define P_SHEDINJA_BALL             3  // Since Gen 4, Shedinja requires a Poké Ball for its evolution. In Gen 3, Shedinja inherits Nincada's Ball.
#define P_KADABRA_EVERSTONE         3  // Since Gen 4, Kadabra can evolve even when holding an Everstone.
