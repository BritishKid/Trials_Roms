...
#define I_KEY_FOSSILS                   3  // In Gen4+, all Gen 3 fossils became regular items.
#define I_KEY_ESCAPE_ROPE               3  // In Gen8, Escape Rope became a Key Item. Keep in mind, this will make it free to buy in marts.
...
#define I_GRISEOUS_ORB_FORM_CHANGE      3  // In Gen9+, the Griseous Orb no longer changes Giratina's form when held.
...
#define I_EXP_SHARE_FLAG        FLAG_XP_ALL_TURNED_ON           // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
