...
#define B_TRAINER_EXP_MULTIPLIER    3 // In Gen7+, trainer battles no longer give a 1.5 multiplier to EXP gain.
...
#define B_EXPLOSION_DEFENSE         3 // In Gen5+, Self-Destruct and Explosion don't halve the targets' defense.
#define B_PARENTAL_BOND_DMG         6 // In Gen7+, Parental Bond's second hit does 25% of the initial hits damage. Before, it did 50%.
...
#define B_GALE_WINGS                6 // In Gen7+ requires full HP to trigger.
...
#define B_SOUL_DEW_BOOST            3 // In Gens3-6, Soul Dew boosts Lati@s' Sp. Atk and Sp. Def. In Gen7+ it boosts the power of their Psychic and Dragon type moves instead.
...
#define B_FLAG_INVERSE_BATTLE       FLAG_INVERSE_BATTLE_ON     // If this flag is set, the battle's type effectiveness are inversed. For example, fire is super effective against water.
...
#define B_FLAG_NO_CATCHING          FLAG_CANT_CATCH_MON     // If this flag is set, the ability to catch wild Pokémon is disabled. Set to turn on and off
