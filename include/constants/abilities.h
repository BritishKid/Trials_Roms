...
//custom abilities
#define ABILITY_BONE_ZONE 312
#define ABILITY_ECHO 313
#define ABILITY_PURE_RAGE 314
#define ABILITY_SAND_FORTRESS 315

#define ABILITIES_COUNT ABILITY_SAND_FORTRESS + 1
