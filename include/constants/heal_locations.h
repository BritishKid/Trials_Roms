...
#define HEAL_LOCATION_FALL_HARBOUR 5
#define HEAL_LOCATION_RUSTBORO_CITY 6
#define HEAL_LOCATION_CORAL_PORT 7
#define HEAL_LOCATION_BREAKWATER_PORT 8
#define HEAL_LOCATION_HEMLOCK_VILLAGE 9
