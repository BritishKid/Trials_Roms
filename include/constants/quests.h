...
#define SUB_QUEST_COUNT (QUEST_1_SUB_COUNT + QUEST_2_SUB_COUNT + QUEST_SALT_SUB_COUNT + QUEST_SCHOOL_SUB_COUNT + QUEST_LOCKED_GATEWAY_SUB_COUNT + QUEST_LOST_PLATES_SUB_COUNT + QUEST_EVOSTONE_SUB_COUNT + QUEST_EVOSTONE_SUB_COUNT)
