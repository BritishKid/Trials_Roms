const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_TM52_SCALD] = {gItemIcon_TM, gItemIconPalette_WaterTMHM},  // Custom Scald TM
    [ITEM_TM53_ROCK_SLIDE] = {gItemIcon_TM, gItemIconPalette_RockTMHM},  // Custom Rock Slide TM
    [ITEM_TM54_GRASS_KNOT] = {gItemIcon_TM, gItemIconPalette_GrassTMHM},  // Custom Grass Knot TM
