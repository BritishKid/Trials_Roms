...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                                ...
                                {EVO_ITEM_HOLD, ITEM_FIRE_STONE, SPECIES_CHARIZARD},
                                {EVO_MAPSEC, MAPSEC_NEW_MAUVILLE, SPECIES_MAGNETON},
                                {EVO_ITEM_HOLD, ITEM_FRESH_WATER, SPECIES_INTELEON},
                                {EVO_MAPSEC, MAPSEC_LITTLEROOT_TOWN, SPECIES_EEVEE_PARTNER})
    },
