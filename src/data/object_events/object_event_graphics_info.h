...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Steelix = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_STEELIX,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 2048,
    .width = 64,
    .height = 64,
    ...
    .oam = &gObjectEventBaseOam_64x64,
    .subspriteTables = sOamTables_64x64,
    .anims = sAnimTable_Standard, //todo maybe add
    .images = sPicTable_SteelixOW,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GoodraHisuin = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_HISUIAN_GOODRA,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 32,
    .height = 32,
    ...
    .subspriteTables = sOamTables_32x32,
    .anims = sAnimTable_Standard, //todo maybe add
    .images = sPicTable_HisuianGoodraOW,
    .affineAnims = gDummySpriteAffineAnimTable,
};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Blastoise = {
    ...
    .subspriteTables = sOamTables_32x32,
    .anims = sAnimTable_Standard, //todo maybe add
    .images = sPicTable_BlastoiseOW,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Pyukumuku = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_PYUKUMUKU,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 32,
    .height = 32,
    ...
    .subspriteTables = sOamTables_32x32,
    .anims = sAnimTable_Standard, //todo maybe add
    .images = sPicTable_PyukumukuOW,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Zorua = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_ZORUA,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 32,
    .height = 32,
