...
{
    [HEAL_LOCATION_PLAYERS_BEDROOM - 1] = {MAP_GROUP(PLAYERS_BEDROOM), MAP_NUM(PLAYERS_BEDROOM), 2, 2},
    [HEAL_LOCATION_GRANITE_PEAK - 1] = {MAP_GROUP(GRANITE_PEAK), MAP_NUM(GRANITE_PEAK), 29, 16},
    [HEAL_LOCATION_SLATEPORT_CITY - 1] = {MAP_GROUP(SLATEPORT_CITY), MAP_NUM(SLATEPORT_CITY), 19, 20},
    [HEAL_LOCATION_MAUVILLE_CITY - 1] = {MAP_GROUP(MAUVILLE_CITY), MAP_NUM(MAUVILLE_CITY), 14, 8},
    [HEAL_LOCATION_RUSTBORO_CITY - 1] = {MAP_GROUP(RUSTBORO_CITY), MAP_NUM(RUSTBORO_CITY), 16, 39},
    [HEAL_LOCATION_CORAL_PORT - 1] = {MAP_GROUP(CORAL_PORT), MAP_NUM(CORAL_PORT), 26, 9},
    [HEAL_LOCATION_LILYCOVE_CITY - 1] = {MAP_GROUP(LILYCOVE_CITY), MAP_NUM(LILYCOVE_CITY), 37, 18},
    [HEAL_LOCATION_MOSSDEEP_CITY - 1] = {MAP_GROUP(MOSSDEEP_CITY), MAP_NUM(MOSSDEEP_CITY), 8, 13},
    ...
    [HEAL_LOCATION_CLAY_HAVEN - 1] = {MAP_GROUP(CLAY_HAVEN), MAP_NUM(CLAY_HAVEN), 31, 27},
    ...
    [HEAL_LOCATION_VERDANTURF_TOWN - 1] = {MAP_GROUP(VERDANTURF_TOWN), MAP_NUM(VERDANTURF_TOWN), 14, 8},
    ...
    [HEAL_LOCATION_SANDY_SHORE_CITY - 1] = {MAP_GROUP(SANDY_SHORE_CITY), MAP_NUM(SANDY_SHORE_CITY), 26, 9},
    [HEAL_LOCATION_OBSIDIAN_PEAK_BASE_CAMP - 1] = {MAP_GROUP(OBSIDIAN_PEAK_BASE_CAMP), MAP_NUM(OBSIDIAN_PEAK_BASE_CAMP), 16, 17},
};
