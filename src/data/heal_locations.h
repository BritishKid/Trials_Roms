...
{
    [HEAL_LOCATION_PLAYERS_BEDROOM - 1] = {MAP_GROUP(PLAYERS_BEDROOM), MAP_NUM(PLAYERS_BEDROOM), 4, 2},
    ...
    [HEAL_LOCATION_GRANITE_PEAK - 1] = {MAP_GROUP(GRANITE_PEAK_TOWN), MAP_NUM(GRANITE_PEAK_TOWN), 34, 17},
    [HEAL_LOCATION_SLATEPORT_CITY - 1] = {MAP_GROUP(SLATEPORT_CITY), MAP_NUM(SLATEPORT_CITY), 19, 20},
    [HEAL_LOCATION_FALL_HARBOUR - 1] = {MAP_GROUP(FALL_HARBOUR), MAP_NUM(FALL_HARBOUR), 21, 16},
    [HEAL_LOCATION_RUSTBORO_CITY - 1] = {MAP_GROUP(RUSTBORO_CITY), MAP_NUM(RUSTBORO_CITY), 16, 39},
    [HEAL_LOCATION_CORAL_PORT - 1] = {MAP_GROUP(CORAL_PORT), MAP_NUM(CORAL_PORT), 25, 9},
    [HEAL_LOCATION_BREAKWATER_PORT - 1] = {MAP_GROUP(BREAKWATER_PORT), MAP_NUM(BREAKWATER_PORT), 52, 24},
    [HEAL_LOCATION_HEMLOCK_VILLAGE - 1] = {MAP_GROUP(HEMLOCK_VILLAGE), MAP_NUM(HEMLOCK_VILLAGE), 8, 12},
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(BEDROCK_TOWN), MAP_NUM(BEDROCK_TOWN), 13, 15},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(BEDROCK_TOWN), MAP_NUM(BEDROCK_TOWN), 13, 15},
    [HEAL_LOCATION_CLAYHAVEN - 1] = {MAP_GROUP(CLAYHAVEN), MAP_NUM(CLAYHAVEN), 34, 27},
    ...
    [HEAL_LOCATION_EMBERFALL_TOWN - 1] = {MAP_GROUP(EMBERFALL_TOWN), MAP_NUM(EMBERFALL_TOWN), 11, 10},
