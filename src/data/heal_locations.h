static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LILYCOVE_CITY - 1] = {MAP_GROUP(LILYCOVE_CITY), MAP_NUM(LILYCOVE_CITY), 52, 23},
    [HEAL_LOCATION_MOSSDEEP_CITY - 1] = {MAP_GROUP(MOSSDEEP_CITY), MAP_NUM(MOSSDEEP_CITY), 8, 12},
    ...
    [HEAL_LOCATION_DEWFORD_TOWN - 1] = {MAP_GROUP(DEWFORD_TOWN), MAP_NUM(DEWFORD_TOWN), 8, 5},
    ...
    [HEAL_LOCATION_SANDY_SHORE_CITY - 1] = {MAP_GROUP(SANDY_SHORE_CITY), MAP_NUM(SANDY_SHORE_CITY), 8, 11},
