static const struct HealLocation sHealLocations[] =
{
    ...
    // [HEAL_LOCATION_BEDROCK_TOWN_MAYS_HOUSE_2F - 1] = {MAP_GROUP(BEDROCK_TOWN_MAYS_HOUSE_2F), MAP_NUM(BEDROCK_TOWN_MAYS_HOUSE_2F), 4, 2},
    [HEAL_LOCATION_GRANITE_PEAK - 1] = {MAP_GROUP(GRANITE_PEAK), MAP_NUM(GRANITE_PEAK), 20, 17},
    ...
    [HEAL_LOCATION_CORAL_PORT - 1] = {MAP_GROUP(CORAL_PORT), MAP_NUM(CORAL_PORT), 5, 7},
    ...
    [HEAL_LOCATION_BEDROCK_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(BEDROCK_TOWN), MAP_NUM(BEDROCK_TOWN), 5, 9},
    [HEAL_LOCATION_BEDROCK_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(BEDROCK_TOWN), MAP_NUM(BEDROCK_TOWN), 14, 9},
    [HEAL_LOCATION_CLAY_HAVEN - 1] = {MAP_GROUP(CLAY_HAVEN), MAP_NUM(CLAY_HAVEN), 6, 17},
