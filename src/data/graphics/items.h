...
const u32 gItemIcon_HandAxe[] = INCBIN_U32("graphics/items/icons/axe.4bpp.lz");
const u32 gItemIconPalette_HandAxe[] = INCBIN_U32("graphics/items/icon_palettes/axe.gbapal.lz");
