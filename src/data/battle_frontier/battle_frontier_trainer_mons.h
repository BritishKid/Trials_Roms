...
const u16 gBattleFrontierTrainerMons_Viktor[] =
{
    FRONTIER_MONS_SCHOOL_TOURNAMENT_1_EXTRA(QUILAVA, SANDSLASH, JOLTEON)
};

const u16 gBattleFrontierTrainerMons_Lily[] =
{
    FRONTIER_MONS_SCHOOL_TOURNAMENT_1_EXTRA(BRAIXEN, SWABLU, GOOMY)
};

const u16 gBattleFrontierTrainerMons_Erifire[] =
{
    FRONTIER_MONS_SCHOOL_TOURNAMENT_1_EXTRA(JOLTEON, TRAPINCH, BRIONNE)
};

const u16 gBattleFrontierTrainerMons_Mart[] =
{
    FRONTIER_MONS_SCHOOL_TOURNAMENT_1_EXTRA(PSYDUCK, SHINX, ROSELIA)
};

const u16 gBattleFrontierTrainerMons_James[] =
{
    FRONTIER_MONS_SCHOOL_TOURNAMENT_1_EXTRA(GRIMER, KADABRA, WOBBUFFET)
};

const u16 gBattleFrontierTrainerMons_Danny[] =
{
    FRONTIER_MONS_SCHOOL_TOURNAMENT_1_EXTRA(ARON, HONEDGE, MAWILE)
};

const u16 gBattleFrontierTrainerMons_Max[] =
{
    FRONTIER_MONS_SCHOOL_TOURNAMENT_1_EXTRA(RIOLU, GRIMER_ALOLAN, CHARCADET)
};

const u16 gBattleFrontierTrainerMons_Alex[] =
{
    FRONTIER_MONS_SCHOOL_TOURNAMENT_1_EXTRA(SILICOBRA, HERDIER, SANDSLASH)
};
