...
u8 TryUpdateRusturfTunnelState(void)
{
        ...
        && gSaveBlock1Ptr->location.mapNum == MAP_NUM(RUSTURF_TUNNEL))
    {
        ...
        {
            VarSet(VAR_EMBERDUNES_BUTTONS_PRESSED, 4);
            return TRUE;
        }
        else if (FlagGet(FLAG_HIDE_RUSTURF_TUNNEL_ROCK_2))
        {
            VarSet(VAR_EMBERDUNES_BUTTONS_PRESSED, 5);
            return TRUE;
        }
    }
    return FALSE;
...
bool8 UsedPokemonCenterWarp(void)
{
    ...
    {
        MAP_CLAY_HAVEN_POKEMON_CENTER_1F,
        MAP_DEWFORD_TOWN_POKEMON_CENTER_1F,
        MAP_LAVARIDGE_TOWN_POKEMON_CENTER_1F,
        MAP_FALLARBOR_TOWN_POKEMON_CENTER_1F,
        MAP_VERDANTURF_TOWN_POKEMON_CENTER_1F,
        MAP_PACIFIDLOG_TOWN_POKEMON_CENTER_1F,
        MAP_GRANITE_PEAK_POKEMON_CENTER_1F,
...
u32 GetMartEmployeeObjectEventId(void)
{
    ...
    {
        { MAP_GROUP(CLAY_HAVEN_MART),     MAP_NUM(CLAY_HAVEN_MART),     LOCALID_CLAY_HAVEN_MART_CLERK },
        ...
        { MAP_GROUP(GRANITE_PEAK_MART),  MAP_NUM(GRANITE_PEAK_MART),  LOCALID_PETALBURG_MART_CLERK },
