...
void SetTrickHouseNuggetFlag(void)
{
    ...
    u16 flag = FLAG_ITEM_HEMLOCK_VILLAGE_NET_BALL;
    *specVar = flag;
    FlagSet(flag);
}
...
void SetDeptStoreFloor(void)
{
    ...
    {
    case MAP_NUM(BREAKWATER_PORT_DEPARTMENT_STORE_1F):
        deptStoreFloor = DEPT_STORE_FLOORNUM_1F;
        break;
    case MAP_NUM(BREAKWATER_PORT_DEPARTMENT_STORE_2F):
        deptStoreFloor = DEPT_STORE_FLOORNUM_2F;
        break;
    case MAP_NUM(BREAKWATER_PORT_DEPARTMENT_STORE_3F):
        deptStoreFloor = DEPT_STORE_FLOORNUM_3F;
        break;
    case MAP_NUM(BREAKWATER_PORT_DEPARTMENT_STORE_4F):
        deptStoreFloor = DEPT_STORE_FLOORNUM_4F;
        break;
    case MAP_NUM(BREAKWATER_PORT_DEPARTMENT_STORE_5F):
        deptStoreFloor = DEPT_STORE_FLOORNUM_5F;
        break;
    case MAP_NUM(BREAKWATER_PORT_DEPARTMENT_STORE_ROOFTOP):
...
u16 GetDeptStoreDefaultFloorChoice(void)
{
    ...
    if (gSaveBlock1Ptr->dynamicWarp.mapGroup == MAP_GROUP(BREAKWATER_PORT_DEPARTMENT_STORE_1F))
    {
        switch (gSaveBlock1Ptr->dynamicWarp.mapNum)
        {
        case MAP_NUM(BREAKWATER_PORT_DEPARTMENT_STORE_5F):
...
bool8 UsedPokemonCenterWarp(void)
{
    ...
    {
        MAP_CLAYHAVEN_POKEMON_CENTER_1F,
        MAP_DEWFORD_TOWN_POKEMON_CENTER_1F,
        MAP_LAVARIDGE_TOWN_POKEMON_CENTER_1F,
        MAP_FALLARBOR_TOWN_POKEMON_CENTER_1F,
        MAP_EMBERFALL_TOWN_POKEMON_CENTER_1F,
        MAP_PACIFIDLOG_TOWN_POKEMON_CENTER_1F,
        MAP_GRANITE_PEAK_TOWN_POKEMON_CENTER_1F,
        MAP_SLATEPORT_CITY_POKEMON_CENTER_1F,
        MAP_FALL_HARBOUR_POKEMON_CENTER_1F,
        MAP_RUSTBORO_CITY_POKEMON_CENTER_1F,
        MAP_CORAL_PORT_POKEMON_CENTER_1F,
        MAP_BREAKWATER_PORT_POKEMON_CENTER_1F,
        MAP_HEMLOCK_VILLAGE_POKEMON_CENTER_1F,
...
u32 GetMartEmployeeObjectEventId(void)
{
    ...
    {
        { MAP_GROUP(CLAYHAVEN_MART),     MAP_NUM(CLAYHAVEN_MART),     LOCALID_OLDALE_MART_CLERK },
        ...
        { MAP_GROUP(EMBERFALL_TOWN_MART), MAP_NUM(EMBERFALL_TOWN_MART), LOCALID_EMBERFALL_MART_CLERK },
        { MAP_GROUP(GRANITE_PEAK_TOWN_MART),  MAP_NUM(GRANITE_PEAK_TOWN_MART),  LOCALID_PETALBURG_MART_CLERK },
        ...
        { MAP_GROUP(CORAL_PORT_MART),    MAP_NUM(CORAL_PORT_MART),    LOCALID_FORTREE_MART_CLERK },
        { MAP_GROUP(HEMLOCK_VILLAGE_MART),   MAP_NUM(HEMLOCK_VILLAGE_MART),   LOCALID_MOSSDEEP_MART_CLERK },
...
void ResetHealLocationFromDewford(void)
{
    if (gSaveBlock1Ptr->lastHealLocation.mapGroup == MAP_GROUP(DEWFORD_TOWN) && gSaveBlock1Ptr->lastHealLocation.mapNum == MAP_NUM(DEWFORD_TOWN))
        SetLastHealLocationWarp(HEAL_LOCATION_GRANITE_PEAK);
}
...
void UpdateTrainerFanClubGameClear(void)
{
    if (!GET_TRAINER_FAN_CLUB_FLAG(FANCLUB_GOT_FIRST_FANS))
    {
        ...
        gSaveBlock1Ptr->vars[VAR_FANCLUB_LOSE_FAN_TIMER - VARS_START] = gSaveBlock2Ptr->playTimeHours;
        // FlagClear(FLAG_HIDE_EXPERT_MEGATOWER);
