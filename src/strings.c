...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("CASSIUS");
const u8 gText_ExpandedPlaceholder_May[] = _("CASSIUS");
...
const u8 gText_DefaultNameRobert[] = _("ROBERT");
const u8 gText_DefaultNameOliver[] = _("OLIVER");
const u8 gText_DefaultNameAlex[] = _("ALEX");
const u8 gText_DefaultNameMatthew[] = _("MATTHEW");
const u8 gText_DefaultNameDavid[] = _("DAVID");
const u8 gText_DefaultNameJude[] = _("JUDE");//todo custom names for rest
...
const u8 gText_DefaultNameTalitha[] = _("TALITHA");
const u8 gText_DefaultNameBella[] = _("BELLA");//todo custom names
...
const u8 gText_BreakwaterPort[] = _("BREAKWATER PORT");
