...
static const struct MatchCallTrainerTextInfo sMatchCallTrainers[] =
{
    ...
    {
        .trainerId = TRAINER_BEACH_GYM_LEADER,
        .unused = 0,
    ...
    {
        .trainerId = FLOWERGLADE_FLORAL_TRAINER_LILY,
        .unused = 0,
    ...
    {
        .trainerId = MEGATOWER2F_TRAINERACE,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(10),
    ...
    {
        .trainerId = MEGATOWER5F_TRAINERACE3,
        .unused = 0,
    ...
    {
        .trainerId = TRAINER_RIVAL_MAHOGONYHILL2,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(8),
    ...
    {
        .trainerId = TRAINER_SALT7_ROUTE_1B_ENCOUNTER,
        .unused = 0,
        // Thalia and Sawyer are the only ones who use different msg ids for their battle topics
...
static const struct MultiTrainerMatchCallText sMultiTrainerMatchCallTexts[] =
{
    ...
    { .trainerId = ROUTE4_SALTS7, .text = gText_Gabby },
