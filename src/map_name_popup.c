...
{
    [MAPSEC_BEDROCK_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CLAYHAVEN] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_EMBERFALL_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PACIFIDLOG_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_GRANITE_PEAK_TOWN] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_SLATEPORT_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_FALL_HARBOUR] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_RUSTBORO_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_CORAL_PORT] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_BREAKWATER_PORT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_HEMLOCK_VILLAGE] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_SANDY_CLIFF] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_LOST_LAKE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_LOST_LAKE2] = MAPPOPUP_THEME_STONE,
    [MAPSEC_MT_PYRE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_OBSIDIAN_THICKET_OLD] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_DARK_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
...
{
    [MAPSEC_BEDROCK_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CLAYHAVEN] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_EMBERFALL_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_PACIFIDLOG_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_GRANITE_PEAK_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SLATEPORT_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FALL_HARBOUR] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_RUSTBORO_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CORAL_PORT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_BREAKWATER_PORT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_HEMLOCK_VILLAGE] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_SANDY_CLIFF] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_LOST_LAKE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_LOST_LAKE2] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MT_PYRE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_OBSIDIAN_THICKET_OLD] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_QUARRY] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_OBSIDIAN_THICKET - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_DARK_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
