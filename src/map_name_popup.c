...
{
    //map name popup location
    [MAPSEC_BEDROCK_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CLAY_HAVEN] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_GRANITE_PEAK] = MAPPOPUP_THEME_BRICK,
