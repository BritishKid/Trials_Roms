...
{
    //forces things for time being for the school tournament
    {FRONTIER_TRAINER_BRADY,   FRONTIER_TRAINER_ALEX},   //   0 -  99
    {FRONTIER_TRAINER_BRADY,   FRONTIER_TRAINER_ALEX},  //  80 - 119
    {FRONTIER_TRAINER_BRADY,   FRONTIER_TRAINER_ALEX},  // 100 - 139
    {FRONTIER_TRAINER_BRADY,   FRONTIER_TRAINER_ALEX}, // 120 - 159
    {FRONTIER_TRAINER_BRADY,   FRONTIER_TRAINER_ALEX}, // 140 - 179
    {FRONTIER_TRAINER_BRADY,   FRONTIER_TRAINER_ALEX},  // 160 - 199
    {FRONTIER_TRAINER_BRADY,   FRONTIER_TRAINER_ALEX},   // 180 - 219
    {FRONTIER_TRAINER_BRADY,   FRONTIER_TRAINER_ALEX}, // 200 - 299
...
u16 GetAllThreeSchoolMonFromSet(u16 trainerId, int number) { //Custom one that should get all 3 mons in the list for school
    SetFacilityPtrsGetLevel(); //needed otherwise things break
...
u8 GetFrontierEnemyMonLevel(u8 lvlMode)
{
    ...
    case FRONTIER_LVL_50:
        level = VarGet(VAR_SCHOOL_TOURNAMENT_LEVEL);
        if(level == 0) {
            level = FRONTIER_MAX_LEVEL_50;
        }
        break;
