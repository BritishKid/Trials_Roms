...
static const struct SubQuest sSubQuests4[QUEST_SALT_SUB_COUNT] =
{
	sub_quest(
	      30,
	      gText_SubQuest4_Name1,
	      gText_SubQuest4_Desc1,
	      gText_SubQuest4_SubMap1,
...
static const struct SubQuest sSubQuests9[QUEST_SCHOOL_SUB_COUNT] = {
	sub_quest(
	      35,
	      gText_SubQuest9_Name1,
	      gText_SubQuest9_Desc1,
	      gText_SideQuestMap9,
	...
	sub_quest(
	      36,
	      gText_SubQuest9_Name2,
	      gText_SubQuest9_Desc2,
	      gText_SideQuestMap9,
	...
	sub_quest(
	      37,
	      gText_SubQuest9_Name3,
	      gText_SubQuest9_Desc3,
	      gText_SideQuestMap9,
	...
	sub_quest(
	      38,
	      gText_SubQuest9_Name4,
	      gText_SubQuest9_Desc4,
	      gText_SideQuestMap9,
	      OBJ_EVENT_GFX_CONTEST_JUDGE,
	      OBJECT,
	      sText_Found
	...
	sub_quest(
	      39,
	      gText_SubQuest9_Name5,
	      gText_SubQuest9_Desc5,
	      gText_SideQuestMap9,
	      OBJ_EVENT_GFX_CONTEST_JUDGE,
	      OBJECT,
	      sText_Found
...
static const struct SubQuest sSubQuests5[QUEST_LOCKED_GATEWAY_SUB_COUNT] =
{
	sub_quest(
	      40,
	...
	sub_quest(
	      43,
	      gText_SubQuest5_Name4,
	      gText_SubQuest5_Desc4,
	      gText_SideQuestMap2,
	...
	sub_quest(
	      44,
	      gText_SubQuest5_Name5,
	      gText_SubQuest5_Desc5,
	      gText_SideQuestMap2,
...
static const struct SubQuest sSubQuests6[QUEST_LOST_PLATES_SUB_COUNT] =
{
	sub_quest(
			45,
	...
	sub_quest(
			49,
			gText_SubQuest6_Name5,
			gText_SubQuest6_Desc5,
			gText_SideQuestMap2,
			ITEM_FLAME_PLATE,
			ITEM,
			sText_Found
	...
	sub_quest(
			50,
			gText_SubQuest6_Name6,
			gText_SubQuest6_Desc6,
			gText_SideQuestMap2,
			ITEM_ICICLE_PLATE,
			ITEM,
			sText_Found
	...
	sub_quest(
			51,
			gText_SubQuest6_Name7,
			gText_SubQuest6_Desc7,
			gText_SideQuestMap2,
			ITEM_INSECT_PLATE,
			ITEM,
			sText_Found
	...
	sub_quest(
			52,
			gText_SubQuest6_Name8,
			gText_SubQuest6_Desc8,
			gText_SideQuestMap2,
			ITEM_IRON_PLATE,
			ITEM,
			sText_Found
	...
	sub_quest(
			53,
			gText_SubQuest6_Name9,
			gText_SubQuest6_Desc9,
			gText_SideQuestMap2,
			ITEM_MEADOW_PLATE,
			ITEM,
			sText_Found
	...
	sub_quest(
			54,
			gText_SubQuest6_Name10,
			gText_SubQuest6_Desc10,
			gText_SideQuestMap2,
			ITEM_MIND_PLATE,
			ITEM,
			sText_Found
	...
	sub_quest(
			55,
			gText_SubQuest6_Name11,
			gText_SubQuest6_Desc11,
			gText_SideQuestMap2,
			ITEM_PIXIE_PLATE,
			ITEM,
			sText_Found
	...
	sub_quest(
			56,
			gText_SubQuest6_Name12,
			gText_SubQuest6_Desc12,
			gText_SideQuestMap2,
			ITEM_SKY_PLATE,
			ITEM,
			sText_Found
	...
	sub_quest(
			57,
			gText_SubQuest6_Name13,
			gText_SubQuest6_Desc13,
			gText_SideQuestMap2,
			ITEM_SPLASH_PLATE,
			ITEM,
			sText_Found
	...
	sub_quest(
			58,
			gText_SubQuest6_Name14,
			gText_SubQuest6_Desc14,
			gText_SideQuestMap2,
			ITEM_SPOOKY_PLATE,
			ITEM,
			sText_Found
	...
	sub_quest(
			59,
			gText_SubQuest6_Name15,
			gText_SubQuest6_Desc15,
			gText_SideQuestMap2,
			ITEM_STONE_PLATE,
			ITEM,
			sText_Found
	...
	sub_quest(
			60,
			gText_SubQuest6_Name16,
			gText_SubQuest6_Desc16,
			gText_SideQuestMap2,
			ITEM_TOXIC_PLATE,
			ITEM,
			sText_Found
	...
	sub_quest(
			61,
			gText_SubQuest6_Name17,
			gText_SubQuest6_Desc17,
			gText_SideQuestMap2,
			ITEM_ZAP_PLATE,
			ITEM,
			sText_Found
	...
	sub_quest(
			62,
			gText_SubQuest6_Name18,
			gText_SubQuest6_Desc18,
			gText_SideQuestMap2,
			ITEM_WHITE_FLUTE,
			ITEM,
			sText_Found
	...
	sub_quest(
			63,
			gText_SubQuest6_Name19,
			gText_SubQuest6_Desc19,
			gText_SideQuestMap2,
			OBJ_EVENT_GFX_BRENDAN_NORMAL,
			OBJECT,
			sText_Found
	...
	sub_quest(
			64,
			gText_SubQuest6_Name20,
			gText_SubQuest6_Desc20,
			gText_SideQuestMap2,
			SPECIES_ARCEUS,
			PKMN,
			sText_Found
...
static const struct SubQuest sSubQuests10[QUEST_LOST_PLATES_SUB_COUNT] =
{
	sub_quest(
			65,
			gText_SubQuest10_Name1,
			gText_SubQuest10_Desc1,
			gText_SubQuest10_SubMap1,
			ITEM_FIRE_STONE,
			ITEM,
			sText_Found
		),
	sub_quest(
			66,
			gText_SubQuest10_Name2,
			gText_SubQuest10_Desc2,
			gText_SubQuest10_SubMap2,
			ITEM_WATER_STONE,
			ITEM,
			sText_Found
		),
	sub_quest(
			67,
			gText_SubQuest10_Name3,
			gText_SubQuest10_Desc3,
			gText_SideQuestMap10,
			ITEM_THUNDER_STONE,
			ITEM,
			sText_Found
	...
	sub_quest(
			68,
			gText_SubQuest10_Name4,
			gText_SubQuest10_Desc4,
			gText_SubQuest10_SubMap4,
			ITEM_LEAF_STONE,
			ITEM,
			sText_Found
		),
	sub_quest(
			69,
			gText_SubQuest10_Name5,
			gText_SubQuest10_Desc5,
			gText_SideQuestMap10,
			ITEM_MOON_STONE,
			ITEM,
			sText_Found
	...
	sub_quest(
			70,
			gText_SubQuest10_Name6,
			gText_SubQuest10_Desc6,
			gText_SideQuestMap10,
			ITEM_SUN_STONE,
			ITEM,
			sText_Found
	...
	sub_quest(
			71,
			gText_SubQuest10_Name7,
			gText_SubQuest10_Desc7,
			gText_SideQuestMap10,
			ITEM_SHINY_STONE,
			ITEM,
			sText_Found
	...
	sub_quest(
			72,
			gText_SubQuest10_Name8,
			gText_SubQuest10_Desc8,
			gText_SideQuestMap10,
			ITEM_DUSK_STONE,
			ITEM,
			sText_Found
	...
	sub_quest(
			73,
			gText_SubQuest10_Name9,
			gText_SubQuest10_Desc9,
			gText_SideQuestMap10,
			ITEM_DAWN_STONE,
			ITEM,
			sText_Found
	...
	sub_quest(
			74,
			gText_SubQuest10_Name10,
			gText_SubQuest10_Desc10,
			gText_SideQuestMap10,
			ITEM_ICE_STONE,
			ITEM,
			sText_Found
	...
	sub_quest(
			75,
			gText_SubQuest10_Name11,
			gText_SubQuest10_Desc11,
			gText_SideQuestMap10,
			ITEM_LINKING_CORD,
			ITEM,
			sText_Found
...
static const struct SubQuest sSubQuests11[QUEST_GIANT_FISH_SUB_COUNT] =
{
	...
	sub_quest(
			78,
			gText_SubQuest11_Name3,
			gText_SubQuest11_Desc3,
			gText_SubQuest11_SubMap3,
			SPECIES_KYOGRE_PRIMAL,
			PKMN,
			sText_Found
		),
	sub_quest(
			79,
			gText_SubQuest11_Name4,
			gText_SubQuest11_Desc4,
			gText_SubQuest11_SubMap4,
			SPECIES_KYOGRE_PRIMAL,
			PKMN,
			sText_Found
		),
	sub_quest(
			80,
			gText_SubQuest11_Name5,
			gText_SubQuest11_Desc5,
			gText_SubQuest11_SubMap5,
			SPECIES_KYOGRE_PRIMAL,
			PKMN,
			sText_Found
		),
	sub_quest(
			81,
			gText_SubQuest11_Name6,
			gText_SubQuest11_Desc6,
			gText_SubQuest11_SubMap6,
			SPECIES_KYOGRE_PRIMAL,
			PKMN,
			sText_Found
		),
	sub_quest(
			82,
			gText_SubQuest11_Name7,
			gText_SubQuest11_Desc7,
			gText_SubQuest11_SubMap7,
			SPECIES_KYOGRE_PRIMAL,
			PKMN,
			sText_Found
		),
	sub_quest(
			83,
			gText_SubQuest11_Name8,
			gText_SubQuest11_Desc8,
			gText_SubQuest11_SubMap8,
			SPECIES_KYOGRE_PRIMAL,
			PKMN,
			sText_Found
		),
...
static const struct SideQuest sSideQuests[QUEST_COUNT] =
{
	...
	side_quest(
	      ...
	      PKMN,
	      sSubQuests5,
	      QUEST_LOCKED_GATEWAY_SUB_COUNT
	),
	side_quest(
...
static void QuestMenu_CreateSprite(u16 itemId, u8 idx, u8 spriteType)
{
	...
	if (ptr[idx] == 0xFF)
	{
		...
		switch (spriteType)
		{
			...
			case PKMN:
				LoadMonIconPalettes();
				// spriteId = CreateMonIcon(itemId, SpriteCallbackDummy, 20, 132, 0, 1, 1); //from the git
				spriteId = CreateMonIcon(itemId, SpriteCallbackDummy, 20, 132, 1, 1 ); //possible issues could come from this
				break;
			default:
				break;
		}
