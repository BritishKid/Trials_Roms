...
static const struct MonChoiceData sStarterChoices[9] = 
{
    ...
    [BALL_MIDDLE_SECOND]    = {SPECIES_PIKACHU_PARTNER, 5, ITEM_ORAN_BERRY},
    [BALL_BOTTOM_FIRST]     = {SPECIES_EEVEE_PARTNER, 5, ITEM_ORAN_BERRY},
    [BALL_BOTTOM_SECOND]    = {SPECIES_NONE, 5, ITEM_ORAN_BERRY}, //todo random?
};
