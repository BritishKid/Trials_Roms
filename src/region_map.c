...
{
    [MAPSEC_BEDROCK_TOWN] = {MAP_GROUP(BEDROCK_TOWN), MAP_NUM(BEDROCK_TOWN), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
    ...
    [MAPSEC_ROUTE_103] = {MAP_GROUP(ROUTE2), MAP_NUM(ROUTE2), HEAL_LOCATION_NONE},
