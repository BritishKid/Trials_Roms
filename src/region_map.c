...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_OBSIDIAN_THICKET,               MAPSEC_BREAKWATER_PORT},
    {MAPSEC_OBSIDIAN_THICKET_OLD,           MAPSEC_BREAKWATER_PORT},
    ...
    {MAPSEC_ALTERING_CAVE,              MAPSEC_SANDY_CLIFF},
    {MAPSEC_DARK_CAVE,               MAPSEC_SANDY_CLIFF},
    {MAPSEC_ABANDONED_SHIP,             MAPSEC_ROUTE_108},
    {MAPSEC_NONE,                       MAPSEC_NONE}
}; //todo make custom map with this
...
{
    [MAPSEC_BEDROCK_TOWN] = {MAP_GROUP(BEDROCK_TOWN), MAP_NUM(BEDROCK_TOWN), HEAL_LOCATION_PLAYERS_BEDROOM},
    [MAPSEC_CLAYHAVEN] = {MAP_GROUP(CLAYHAVEN), MAP_NUM(CLAYHAVEN), HEAL_LOCATION_CLAYHAVEN},
    ...
    [MAPSEC_EMBERFALL_TOWN] = {MAP_GROUP(EMBERFALL_TOWN), MAP_NUM(EMBERFALL_TOWN), HEAL_LOCATION_EMBERFALL_TOWN},
    [MAPSEC_PACIFIDLOG_TOWN] = {MAP_GROUP(PACIFIDLOG_TOWN), MAP_NUM(PACIFIDLOG_TOWN), HEAL_LOCATION_PACIFIDLOG_TOWN},
    [MAPSEC_GRANITE_PEAK_TOWN] = {MAP_GROUP(GRANITE_PEAK_TOWN), MAP_NUM(GRANITE_PEAK_TOWN), HEAL_LOCATION_GRANITE_PEAK},
    [MAPSEC_SLATEPORT_CITY] = {MAP_GROUP(SLATEPORT_CITY), MAP_NUM(SLATEPORT_CITY), HEAL_LOCATION_SLATEPORT_CITY},
    [MAPSEC_FALL_HARBOUR] = {MAP_GROUP(FALL_HARBOUR), MAP_NUM(FALL_HARBOUR), HEAL_LOCATION_FALL_HARBOUR},
    [MAPSEC_RUSTBORO_CITY] = {MAP_GROUP(RUSTBORO_CITY), MAP_NUM(RUSTBORO_CITY), HEAL_LOCATION_RUSTBORO_CITY},
    [MAPSEC_CORAL_PORT] = {MAP_GROUP(CORAL_PORT), MAP_NUM(CORAL_PORT), HEAL_LOCATION_CORAL_PORT},
    [MAPSEC_BREAKWATER_PORT] = {MAP_GROUP(BREAKWATER_PORT), MAP_NUM(BREAKWATER_PORT), HEAL_LOCATION_BREAKWATER_PORT},
    [MAPSEC_HEMLOCK_VILLAGE] = {MAP_GROUP(HEMLOCK_VILLAGE), MAP_NUM(HEMLOCK_VILLAGE), HEAL_LOCATION_HEMLOCK_VILLAGE},
    ...
    [MAPSEC_ROUTE_1] = {MAP_GROUP(ROUTE1A), MAP_NUM(ROUTE1A), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_2] = {MAP_GROUP(ROUTE1B), MAP_NUM(ROUTE1B), HEAL_LOCATION_NONE},
    [MAPSEC_SANDY_CLIFF] = {MAP_GROUP(ROUTE2), MAP_NUM(ROUTE2), HEAL_LOCATION_NONE},
...
static void RegionMap_InitializeStateBasedOnSSTidalLocation(void)
{
    ...
    case SS_TIDAL_LOCATION_LILYCOVE:
        sRegionMap->mapSecId = MAPSEC_BREAKWATER_PORT;
        break;
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_BEDROCK_TOWN:
        return FlagGet(FLAG_VISITED_LITTLEROOT_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CLAYHAVEN:
        return FlagGet(FLAG_VISITED_CLAYHAVEN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    ...
    case MAPSEC_EMBERFALL_TOWN:
        return FlagGet(FLAG_VISITED_EMBERFALL_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PACIFIDLOG_TOWN:
        return FlagGet(FLAG_VISITED_PACIFIDLOG_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GRANITE_PEAK_TOWN:
        return FlagGet(FLAG_VISITED_GRANITE_PEAK_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SLATEPORT_CITY:
        return FlagGet(FLAG_VISITED_SLATEPORT_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_FALL_HARBOUR:
        return FlagGet(FLAG_VISITED_FALL_HARBOUR) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_RUSTBORO_CITY:
        return FlagGet(FLAG_VISITED_RUSTBORO_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CORAL_PORT:
        return FlagGet(FLAG_VISITED_CORAL_PORT) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_BREAKWATER_PORT:
        return FlagGet(FLAG_VISITED_BREAKWATER_PORT) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_HEMLOCK_VILLAGE:
        return FlagGet(FLAG_VISITED_HEMLOCK_VILLAGE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_BEDROCK_TOWN; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
