...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_CLAY_HAVEN] = {MAP_GROUP(CLAY_HAVEN), MAP_NUM(CLAY_HAVEN), HEAL_LOCATION_CLAY_HAVEN},
    ...
    [MAPSEC_GRANITE_PEAK] = {MAP_GROUP(GRANITE_PEAK), MAP_NUM(GRANITE_PEAK), HEAL_LOCATION_GRANITE_PEAK},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_BEDROCK_TOWN:
        return FlagGet(FLAG_VISITED_BEDROCK_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CLAY_HAVEN:
        return FlagGet(FLAG_VISITED_CLAY_HAVEN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    ...
    case MAPSEC_GRANITE_PEAK:
        return FlagGet(FLAG_VISITED_GRANITE_PEAK) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_BEDROCK_TOWN;
        ...
        if (!UpdatePaletteFade())
        {
            ...
            if (sFlyMap->choseFlyLocation)
            {
                ...
                case MAPSEC_BATTLE_FRONTIER:
                    ...
                    break;
                case MAPSEC_BEDROCK_TOWN:
                    SetWarpDestinationToHealLocation(gSaveBlock2Ptr->playerGender == MALE ? HEAL_LOCATION_BEDROCK_TOWN_BRENDANS_HOUSE : HEAL_LOCATION_BEDROCK_TOWN_MAYS_HOUSE);
                    break;
                case MAPSEC_EVER_GRANDE_CITY:
