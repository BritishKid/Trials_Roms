...
static const match_call_text_data_t sMrStoneTextScripts[] = {
    ...
    { MatchCall_Text_MrStone5,  FLAG_RECEIVED_TYROGUE,           0xFFFF },
    { MatchCall_Text_MrStone6,  FLAG_DEFEATED_PETALBURG_GYM,         0xFFFF },
    { MatchCall_Text_MrStone7,  FLAG_RECEIVED_TYROGUE,              0xFFFF },
...
static const match_call_text_data_t sWallyTextScripts[] = {
    ...
    { MatchCall_Text_Wally4, FLAG_RECEIVED_TYROGUE,              0xFFFF },
...
static const match_call_text_data_t sScottTextScripts[] = {
    ...
    { MatchCall_Text_Scott3, FLAG_RECEIVED_TYROGUE,              0xFFFF },
...
static const struct MatchCallStructNPC sScottMatchCallHeader =
{
    .type = 0,
    .mapSec = MAPSEC_NONE,
    .flag = FLAG_BRAD_GIVES_SHINY_AXEW,
