...
{
    [REMATCH_GYM_XP_DUMP] = REMATCH(GYM_XP_DUMP, GYM_XP_DUMP, GYM_XP_DUMP, GYM_XP_DUMP, GYM_XP_DUMP, ROUTE105),
    ...
    // [REMATCH_LOLA] = REMATCH(TRAINER_WATERFALL_CAVE_BLACKBELT_1, TRAINER_WATERFALL_CAVE_EXPERT, TRAINER_DEREK_OBSIDIAN_THICKET, BEACH1_CLAIR_BATTLE, TRAINER_TESSA_GYM3, ROUTE109),
    // [REMATCH_RICKY] = REMATCH(TRAINER_PABLO_GYM3, TRAINER_OLLIE_GYM3, ROUTE4_ODA_BLACKBELT, EMBERDUNE_MANIAC, TRAINER_RICKY_5, ROUTE109),
    ...
    [REMATCH_BROOKE] = REMATCH(MEGAMANSION_TRAINER6, TRAINER_BROOKE_2, TRAINER_BROOKE_3, TRAINER_BROOKE_4, TRAINER_BROOKE_5, ROUTE111),
    // [REMATCH_WILTON] = REMATCH(TRAINER_AY_GYM4, FLOWERGLADE_FLORAL_TRAINER_LILY, TRAINER_ACE_MARQUES, TRAINER_DARKCAVEGF_WARNINGTRAINER, TRAINER_COLIN_OBSIDIAN_THICKET, ROUTE111),
    [REMATCH_VALERIE] = REMATCH(TRAINER_VALERIE_1, QUARRY_WORKER2, QUARRY_FISHERMAN, QUARRY_SALTS7, LILYCOVE_GAMER, MT_PYRE_6F),
    [REMATCH_CINDY] = REMATCH(TRAINER_BRAD_HIDDEN_BASE, TRAINER_CINDY_3, TRAINER_CINDY_4, TRAINER_CINDY_5, TRAINER_CINDY_6, ROUTE104),
    ...
    // [REMATCH_LYDIA] = REMATCH(TRAINER_LYDIA_1, TRAINER_DARKCAVE_HIKER1, TRAINER_DARKCAVE_HIKER2, TRAINER_DARKCAVE_ACE, TRAINER_LYDIA_5, ROUTE117),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_ROUTE2_TRAINER1, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MT_CHIMNEY), //OVERWRITTEN FOR ROUTE 2 TRAINER 1 FIX LATER
    ...
    [REMATCH_ROXANNE] = REMATCH(TRAINER_ROXANNE_1, CHAMPION_MAT, TRAINER_OLLIE_CHAMPION, TRAINER_ALEX_CHAMPION, TRAINER_GATTO_CHAMPION, RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_BRAWLY_1, TRAINER_PULSAR_CHAMPION, TRAINER_BRAWLY_3, TRAINER_BRAWLY_4, TRAINER_BRAWLY_5, DEWFORD_TOWN),
    ...
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN_1, TRAINER_NORMAN_2, TRAINER_NORMAN_3, TRAINER_NORMAN_4, TRAINER_NORMAN_5, GRANITE_PEAK),
...
void StartRedGyradosEncounter(void)
{
    CreateShinyMon(&gEnemyParty[0], SPECIES_GYARADOS, 20);
    LockPlayerFieldControls();
...
u8 GetTrainerBattleTransition(void)
{
    ...
    if (gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_ACE_TRAINER
...
static bool32 IsRematchForbidden(s32 rematchTableId)
{
    ...
    else if (rematchTableId == REMATCH_GYM_XP_DUMP) //should be able to make gym fight repeatable
        return TRUE;
    else
        return FALSE;
}
