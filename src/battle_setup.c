...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] = //todo tidy this up sometime
{
    [REMATCH_ROSE] = REMATCH(TRAINER_MOVEBOY, TRAINER_FRONTPAGEROB_SECRET_BASE, ROUTE3_FISHERMAN_NEET, ROUTE3_CAMPER_DAVE, ROUTE3_ROSE, ROUTE118),
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_1, TRAINER_ANDRES_2, TRAINER_ANDRES_3, TRAINER_ANDRES_4, TRAINER_ANDRES_5, ROUTE105),
    [REMATCH_DUSTY] = REMATCH(ROUTE3_LILY, ROUTE4_BUGCATCHER, ROUTE4_LANDO, ROUTE4_OSTRICHPUPPET, ROUTE4_ODA_BLACKBELT, ROUTE111),
    [REMATCH_LOLA] = REMATCH(TRAINER_BEACH_GYM_LEADER, TRAINER_BUMBLE, BUGTRAINER_MARK, GENTLEMAN_ARTHUR, LASS_JESSICA, ROUTE109),
    [REMATCH_RICKY] = REMATCH(EXPERT_HERBERT, TRAINER_KEVIN_GYMLEADER, OT1YOUNSGTER, CAMPER_KATTY, HEMLOCKGYM_TRAINER_TESSA, ROUTE109),
    ...
    [REMATCH_BROOKE] = REMATCH(FLOWERGLADE_FLORAL_TRAINER_LILY, TRAINER_FOURTH_ENCOUNTER_ROBERT, TRAINER_SARAH_GYMLEADER, TRAINER_OLLIE_GYM4, TRAINER_BITTERS_GYM4, ROUTE111),
    [REMATCH_WILTON] = REMATCH(THUGCITY_COMMANDER, TRAINER_WATERFALLCAVE_BLACKBELT2, TRAINER_WATERFALLCAVE_BLACKBELT3, TRAINER_WATERFALL_CAVE_EXPERT, REFLEX_TRAINER, ROUTE111),
    [REMATCH_VALERIE] = REMATCH(QUARRY_WORKER2, TRAINER_QUARRYWORKER_STUCK1, EMBERDUNECAVE_ICEMAN, ROUTE5_DOGWALKER, ROUTE7_DRAGONTAMER, MT_PYRE_6F),
    [REMATCH_CINDY] = REMATCH(EMBERDUNE_FOSSILBOY, DOJO1_BLACKBELT2, DOJO1_EXPERT, MEGATOWER1F_TRAINER1, MEGATOWER1F_TRAINER2, ROUTE104),
    ...
    [REMATCH_JESSICA] = REMATCH(MEGATOWER2F_TRAINERACE, MEGATOWER4F_TRAINER2, MEGATOWER4F_TRAINERACE, MEGATOWER5F_TRAINERACE1, MEGATOWER5F_TRAINERACE2, ROUTE121),
    [REMATCH_WINSTON] = REMATCH(MEGATOWER5F_TRAINERACE3, MEGATOWER_RIVAL, TRAINER_WINSTON_3, TRAINER_WINSTON_4, TRAINER_WINSTON_5, ROUTE104),
    ...
    [REMATCH_MIGUEL] = REMATCH(TRAINER_MIGUEL_1, TRAINER_MIGUEL_2, TRAINER_MIGUEL_3, TRAINER_MIGUEL_4, TRAINER_MIGUEL_5, ROUTE2),
    ...
    [REMATCH_CALVIN] = REMATCH(TRAINER_CALVIN_1, TRAINER_CALVIN_2, TRAINER_CALVIN_3, TRAINER_CALVIN_4, TRAINER_CALVIN_5, ROUTE1B),
    ...
    [REMATCH_AMY_AND_LIV] = REMATCH(TRAINER_AMY_AND_LIV_1, TRAINER_AMY_AND_LIV_2, TRAINER_AMY_AND_LIV_4, TRAINER_AMY_AND_LIV_5, TRAINER_AMY_AND_LIV_6, ROUTE2),
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_RIVAL_MAHOGONYHILL2, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MT_PYRE_3F),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_SALT7_ROUTE_1B_ENCOUNTER, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MT_CHIMNEY),
    ...
    [REMATCH_WATTSON] = REMATCH(TRAINER_WATTSON_1, TRAINER_WATTSON_2, TRAINER_WATTSON_3, TRAINER_WATTSON_4, TRAINER_WATTSON_5, FALL_HARBOUR),
    ...
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN_1, TRAINER_NORMAN_2, TRAINER_NORMAN_3, TRAINER_NORMAN_4, TRAINER_NORMAN_5, GRANITE_PEAK_TOWN),
    [REMATCH_WINONA] = REMATCH(TRAINER_WINONA_1, TRAINER_WINONA_2, TRAINER_WINONA_3, TRAINER_WINONA_4, TRAINER_WINONA_5, CORAL_PORT),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_TATE_AND_LIZA_1, TRAINER_TATE_AND_LIZA_2, TRAINER_TATE_AND_LIZA_3, TRAINER_TATE_AND_LIZA_4, TRAINER_TATE_AND_LIZA_5, HEMLOCK_VILLAGE),
